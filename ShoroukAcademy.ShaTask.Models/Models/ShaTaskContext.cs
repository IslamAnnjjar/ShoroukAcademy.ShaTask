...
namespace ShoroukAcademy.ShaTask.Models.Models
{
    public partial class ShaTaskContext : IdentityDbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Data Source =.; Initial Catalog= ShaTask; Integrated Security = True;MultipleActiveResultSets=true");
            }
        }
